...
const TeleCallingContent = () => (
  <div className="static-content">
    <h1>Tele-Calling Guidelines</h1>
    ...
    <p>Dear Customer, thanks for registering your contact details with us "Isa Spa Salon & Spa - Kochi" on Facebook / Instagram! We look forward to seeing you at the salon. Offer valid till - 25th Sep!</p>
    <ul>
...
export default TeleCallingContent;
