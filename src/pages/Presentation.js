            ...
            <Col xs={12} className="text-center">
              ...
              <div className="d-flex align-items-center justify-content-center">
                <Button
                  variant="secondary"
                  as={Link}
                  to={AppRoutes.DashboardOverview.path}
            ...
            <Col xs={12} lg={6} className="mb-4">
              <div className="d-none d-lg-block mt-5">
                ...
                <Button
                  ...
                  variant="secondary"
                  size="md"
                  to={AppRoutes.DocsFolderStructure.path}
                  target="_blank"
                  className="text-dark"
                >
            ...
            >
              <ListGroup className="d-block fmw-100 list-style-none folder-structure">
                ...
                <ListGroup className="list-style-none ps-4">
                  ...
                  <FolderItem
                    name="AppRoutes.js"
                    tooltip="The file where the AppRoutes are registered at"
                    icon={faJs}
                    iconColor="secondary"
                  />
                </ListGroup>
          ...
          <Row className="justify-content-center">
            <Col md={10} xl={9}>
              ...
              <p className="mt-4 text-white text-center mb-0">
                ...
                <Link
                  to={AppRoutes.DocsQuickStart.path}
            ...
            <Col xs={6} md={2} className="mb-5 mb-lg-0">
              ...
              <ul className="links-vertical mt-2">
                ...
                <li>
                  <Card.Link
                    as={Link}
                    to={AppRoutes.DocsChangelog.path}
                    target="_blank"
                  >
                    Changelog
                  </Card.Link>
